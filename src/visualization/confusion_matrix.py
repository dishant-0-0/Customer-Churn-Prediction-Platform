...
def create_confusion_matrix(evaluation: EvaluationResult) -> Figure:
    """
    ...
    ax.set_title(
        "Confusion Matrix", fontsize=settings.visualization.font.title_size
    )

    ax.set_xlabel(
        "Predicted Label", fontsize=settings.visualization.font.label_size
    )

    ax.set_ylabel(
        "True Label", fontsize=settings.visualization.font.label_size
    )
